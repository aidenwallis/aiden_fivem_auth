...
import (
	...
	"github.com/aidenwallis/fivem-external-sessions/internal/expiry"
	"github.com/aidenwallis/fivem-external-sessions/internal/migrations"
	"github.com/aidenwallis/fivem-external-sessions/internal/privateapi"
	"github.com/aidenwallis/fivem-external-sessions/internal/publicapi"
...
func help() {
	golog.Println("fivem-sessions <command>")
...
func makeMigration(dbImpl db.DB) {
	name := flag.Arg(1)
	if name == "" {
		golog.Println("usage: fivem-sessions make-migration <name_of_migration>")
		return
	}
